...
module.exports = (options = {}, context) => ({
  ...
  define () {
    ...
    const MATOMO_TRACKER_URL = options.trackerUrl || siteConfig.trackerUrl || "https://kpi.unikname.com/";
    ...
    const MATOMO_TRACKER_JS_FILE = options.trackerJsFile || "js/";
    const MATOMO_TRACKER_PHP_FILE = options.trackerPhpFile || "r.php";
